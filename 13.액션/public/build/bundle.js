...
var app = (function () {
    ...
    const file$2 = "src/Example1.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			add_location(div, file$2, 47, 2, 1039);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);

    			if (!mounted) {
    				dispose = action_destroyer(hello2_action = hello2.call(null, div, {
    		...
    		p: function update(ctx, dirty) {
    			if (hello2_action && is_function(hello2_action.update) && dirty & /*width*/ 2) hello2_action.update.call(null, {
    				width: `${/*width*/ ctx[1]}px`,
    				height: '70px',
    				color: 'red'
    			});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$2, 36, 0, 842);
    			add_location(button1, file$2, 39, 0, 905);
    			add_location(div0, file$2, 43, 0, 965);
    			add_location(div1, file$2, 44, 0, 987);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					action_destroyer(hello.call(null, div0)),
    					action_destroyer(hello.call(null, div1, 'royalblue'))
    				];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Example1> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => $$invalidate(0, toggle = !toggle);
    	const click_handler_1 = () => $$invalidate(1, width += 20);
    	$$self.$capture_state = () => ({ hello, toggle, width, hello2 });
    	...
    	return [toggle, width, click_handler, click_handler_1];
    }
    ...
    const file$1 = "src/Example2.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			div1 = element("div");
    			attr_dev(div0, "class", "svelte-p8lkta");
    			add_location(div0, file$1, 22, 0, 497);
    			attr_dev(div1, "class", "svelte-p8lkta");
    			add_location(div1, file$1, 23, 0, 518);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					action_destroyer(zoom.call(null, div0)),
    					action_destroyer(zoom.call(null, div1, 0.7))
    				];
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h10 = element("h1");
    			h10.textContent = "1. 사용 패턴 정리";
    			t1 = space();
    			h11 = element("h1");
    			h11.textContent = "2. 요소 Zoom In-Out 예제";
    			t3 = space();
    			create_component(example2.$$.fragment);
    			add_location(h10, file, 5, 0, 106);
    			add_location(h11, file, 8, 0, 152);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
